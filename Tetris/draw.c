...
void draw_guide(void) 
{
	...
	paintText(30,100,
" Welcome to Tetris!"
" In this game, you move blocks and try to clear lines."
" When a line is completely filled with blocks,it will be cleared and "
);
	paintText(0,150,
" you'll earn points.Clearing more lines at once "
" grants more points (points for clearing n lines = 200*n*n)."
);
	paintText(30,200," Control keys:	");
	paintText(30,400," Enjoy your Tetris journey!");
	setTextFont(" Noto Sans SC Black");
	paintText(0,250," <-- / --> : left / right");
	paintText(250,250," VK_DOWN : Soft-drop (faster fall)");
	paintText(600,250," VK_UP : Change the blocks");
	paintText(890,250," Space : Hard-drop");
	paintText(0,300," P : Pause");
	paintText(250,300," R : Restart");
	paintText(460,300," Q : Increase falling speed (*2)");
	paintText(800,300," S : Decrease falling speed (/2)");
	paintText(0,350," C : Use \"clear chance\" (once per game) to clear all blocks");
	paintText(660,350," B : Start game.");
	setTextSize(25);
